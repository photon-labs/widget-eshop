...
<script type="text/javascript" src="lib/yui/build/querystring/querystring-min.js"></script>
...
<script type="text/javascript" src="js/eshop/widgets/NewProductsWidget.js"></script>
