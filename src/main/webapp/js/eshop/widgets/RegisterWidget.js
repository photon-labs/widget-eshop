        ...
        createContent : function(targetNode) {
           if (true) {
                ...
                var phoneDiv = this.createElement('<div id="regphonenumber_err_div" class="clearfix">');
                    var phoneField = this.createElement('<label for="phone"><span>Phone # *</span><input type="phone" name="regphonenumber" id="regphonenumber" placeholder="Phone Number" /></label><span class="help-inline" id="regphonenumber_err"></span>');
