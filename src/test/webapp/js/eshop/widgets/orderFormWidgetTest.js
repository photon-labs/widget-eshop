YUI.add('orderFormWidgetTest', function(Y) {
		...
		var testCase = new Y.Test.Case({
			...
			"OrderFormWidgetTest with same data": function () {
				...
				var productQty = {productDetail:[{detailImageURL:"http://172.16.17.180:20...uct/details/lg_tv_5.png", imageURL:"http://172.16.17.180:2020//images/web/product/lg_tv_5.png",
